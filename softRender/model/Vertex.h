...
struct VertexShadeOut {
    ...
    VertexShadeOut() = default;
    VertexShadeOut(const Maths::Vector4f &wv,
    ...
    VertexShadeOut(const VertexShadeOut &vs) {
    ...
    VertexShadeOut &operator=(const VertexShadeOut &vs) {
        if (this == &vs)
            return *this;
        world_view = vs.world_view;
        view_projection = vs.view_projection;
